...
void remap_pins_drive_forward() {
    ...
    RPOR2bits.RP68R = 0b010000;         // RD4 - PWMD output OC1
    RPOR1bits.RP66R = 0b010000;         // RD2 - PWMB output OC1

    /* Set RD1 and RD3 as outputs and drive them low */  // 【追加】
    TRISDbits.TRISD1 = 0;               // RD1 set as output  【追加】
    TRISDbits.TRISD3 = 0;               // RD3 set as output  【追加】
    LATDbits.LATD1 = 0;                 // RD1 output LOW     【追加】
    LATDbits.LATD3 = 0;                 // RD3 output LOW     【追加】
}
